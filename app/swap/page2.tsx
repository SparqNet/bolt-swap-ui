...
export default function Swap() {
  ...
  function switchDirection() {
    ...
    // mktRate["usdc"], usdc: mktRate["eth"]
    setMktRate({ eth: 1000, usdc: 1});
  }
  ...
  return (
    <div className="pt-[10vh]">
      <div className="flex flex-col w-full md:max-w-md px-6 pt-5 pb-7 mx-auto bg-black border border-grey2 rounded-xl">
        ...
        <SwapButton zeroForOne={tokenOut.address != "" && tokenIn.address < tokenOut.address} amount={bnInput} baseLimit={baseLimit} /> : null 
         {/* } */}
      </div>
    </div>
  );
